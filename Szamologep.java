...
public class Szamologep extends JFrame implements ActionListener{
    ...
    public Szamologep() throws HeadlessException {
        ...
        bt1=new JButton(" ");
        bt2=new JButton("<html><body><fontcolor=#FF0000>Backspace</font></body></html>");
        bt3= new JButton("<html><body><fontcolor=#FF0000>CE</font></body></html>" );
        bt4=new JButton("<html><body><fontcolor=#FF0000>C</font></body></html>");
        bt5=new JButton("<html><body><fontcolor=#FF0000>MC</font></body></html>");
        bt6=new JButton("7");
        bt7=new JButton("8");
        bt8=new JButton("9");
        bt9=new JButton("/");
        bt10=new JButton("sqrt");
        bt11=new JButton("<html><body><fontcolor=#FF0000>MR</font></body></html>");
        bt12=new JButton("4");
        bt13=new JButton("5");
        bt14=new JButton("6");
        bt15=new JButton("*");
        bt16=new JButton("%");
        bt17=new JButton("<html><body><fontcolor=#FF0000>MS</font></body></html>");
        bt18=new JButton("1");
        bt19=new JButton("2");
        bt20=new JButton("3");
        bt21=new JButton("-");
        bt22=new JButton("1/x");
        bt23=new JButton("<html><body><fontcolor=#FF0000>M+</font></body></html>");
        bt24=new JButton("0");
        bt25=new JButton("+/-");
        bt26=new JButton(".");
        bt27=new JButton("+");
